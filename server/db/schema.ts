import {
  ...
  import type { SourceRawData,SourceMetadata ,JsonValue} from "@/shared/contracts/ingestion";
  import { sourceFormat,sourceType,importStatus } from "@/shared/contracts/ingestion";
  ...
  export const importsTable = pgTable(
    "imports",
    {
      ...
      malformedRows: integer("malformed_rows")
        .default(0)
        .notNull(),
  ...
  export const ingestedItemsTable = pgTable(
    ...
    (table) => [
      unique("ingested_items_import_row_unique").on(
        table.importId,
        table.rowKey,
      ),
    ],
