...
const sharedElements = {
  ...
  formButtonPrimary:
    "h-10 rounded-full bg-accent text-sm font-medium text-accent-foreground shadow-none hover:bg-accent-hover",
...
function variables(theme: Theme) {
  if (theme === "dark") {
    return {
      ...
      colorPrimary: "#6eb8a6",
      colorPrimaryForeground: "#0f0f0e",
      colorMuted: "#272621",
      colorMutedForeground: "#9c978c",
      colorInput: "#0f0f0e",
      colorInputForeground: "#f2efe6",
      colorNeutral: "#9c978c",
      colorDanger: "#e08a7c",
      colorSuccess: "#6eb8a6",
      colorWarning: "#e0c36a",
      colorBorder: "rgba(242, 239, 230, 0.11)",
